...
![hyLogo](images/University_of_Helsinki.logo.png){:height="50%" width="50%"}|    ![aaltoLogo](images/Aalto_University_logo.png){:height="43%" width="43%"}|![ouluLogo](images/Oulu_logo.png){:height="150%" width="150%"} 
